...
## Revenue path
Free provides local import, explicit installable on-device Speech AI, basic Vietnamese system voice, quality-normalized balanced dub, standard playback/PiP, subtitles, recovery after interruption, and single-speaker fast dub. Plus remains planned for natural Vietnamese voices, multi-speaker mapping, a real verified clean-background/source-separation engine, richer dual-audio controls, smart speed, dictionary, summary, and advanced offline model/cache management.
